...
const Home = () => {
  return (
    ...
    <section id="home" style={{ display: 'flex', alignItems: 'center', minHeight: '100%', position: 'relative' }}>
      {/* O componente de background deve vir antes do conteúdo principal
          e ser posicionado absolutamente para ficar no fundo. */}
      <BackgroundEffect />

      <Container className="p-0 fade-in gradient-background" style={{ position: 'relative', zIndex: 10 }}> {/* Adicionado position: 'relative' e zIndex para o conteúdo ficar por cima */}
